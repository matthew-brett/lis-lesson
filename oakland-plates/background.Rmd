...
So, we will get the Oakland data, clean it up, and do some analysis. For the
cleaning step, see [cleaning the data](clean_plates.Rmd).  You don't need to
run the cleaning step, we have already done this and saved the cleaned data. In
fact, the cleaning step takes a fairly large amount of memory, and systems
without much memory, it may crash.  At least the cleaning notebook will show
what cleaning we did.
