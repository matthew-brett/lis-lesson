...
Oakland is just across the Bay from San Francisco, and a few miles from Berkeley.  Here's a map, marking the City Hall and the Police Department (for reasons we will come to soon):
...
cameras, constantly feeding automated read license plates with location data to
police databases.
