...
We load all the CSV files as Pandas data frames.  Notice the
slight differences in the column names and number of columns in
the CSV files.
...
We need to do some cleanup.  There is a data frame with lower
case names, where the rest have capitalized names.  Some data
frames have extra columns we are not interested in.
